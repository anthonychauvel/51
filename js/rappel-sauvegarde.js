...
(function(){
  ...
  function show(reason){
    ...
    var txt=reason==='year'?'Nouvel exercice : c\u2019est le bon moment pour sauvegarder tes donn\u00e9es.'
                          :'P\u00e9riode cl\u00f4tur\u00e9e : c\u2019est le bon moment pour sauvegarder tes donn\u00e9es.';
    var l=lastISO();
    var sub=l?'Derni\u00e8re sauvegarde : '+l.split('-').reverse().join('/'):'Aucune sauvegarde pour l\u2019instant.';
    ...
    s.innerHTML='<div style="color:#fff;font-size:13px;font-weight:700;line-height:1.35">\ud83d\udcbe '+txt+'</div>'
      ...
      +'<button type="button" data-a="go" style="background:#2196a6;color:#fff;border:none;border-radius:9px;padding:8px 16px;font-size:13px;font-weight:800">Sauvegarder</button></div>';
  ...
  window.hsBackupCheckDates=function(dates){
    try{
      ...
      if(hit)window.hsBackupNudge('period');
    }catch(e){}
  };
})();
